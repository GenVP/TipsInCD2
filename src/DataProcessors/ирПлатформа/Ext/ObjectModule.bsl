					...
					Тогда
						...
						Для Каждого Тип Из МассивТипов Цикл
							...
							ИначеЕсли ТипЗнч(Тип) = Тип("Строка") Тогда
								_КорневойТип = ирОбщий.ПервыйФрагментЛкс(Тип, ".");
								_СтрокаОбщегоТипа = ТаблицаОбщихТипов.Найти(_КорневойТип + "Ссылка", "БазовыйТип");
								
								_Метаданные = Новый Соответствие;
								_Метаданные.Вставить("ПолноеИмя", Тип);
								_Метаданные.Вставить("Конфигурация", РодительскаяСтруктураТипа.Метаданные["Конфигурация"]);
								
								СтруктураТипаСвойства = ПолучитьНовуюСтруктуруТипа();
								СтруктураТипаСвойства.Метаданные = _Метаданные;
								СтруктураТипаСвойства.ИмяОбщегоТипа = _СтрокаОбщегоТипа.Слово;
							//-КД2
							ИначеЕсли Истина
								И Это2iS
