...
Функция кд_глПолучитьМетаданныеИзКэша(МетаданныеРодителя) Экспорт
	
	Если кд_КэшМетаданных = Неопределено Тогда
		кд_КэшМетаданных = Новый Соответствие;
	КонецЕсли;
	кд_МетаданныеКонфигурация = кд_КэшМетаданных[МетаданныеРодителя["Конфигурация"]];
	Если кд_МетаданныеКонфигурация = Неопределено Тогда
		кд_МетаданныеКонфигурация = Новый Соответствие;
		кд_КэшМетаданных[МетаданныеРодителя["Конфигурация"]] = кд_МетаданныеКонфигурация;
	КонецЕсли;
...
Процедура кд_СохранитьМетаданныеВКэше(МетаданныеРодителя, МетаданныеОбъекта) Экспорт
