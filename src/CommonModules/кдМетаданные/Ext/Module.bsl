...
Функция ПолучитьКоллекциюОбъектов(МетаданныеРодителя, ИмяКоллекции, Настройки = Неопределено) Экспорт
	...
	ТаблицаМетаданных = ПолучитьТаблицуМетаданныхИзФайла(Настройки, МетаданныеРодителя, ИмяКоллекции);
	...
	Сообщить("Время получения " + ИмяКоллекции + " " + (_КонецЗамера - _НачалоЗамера));
	
	Возврат НайденныеОбъекты;
	
КонецФункции

Функция ПолучитьТаблицуМетаданныхИзФайла(Настройки, ОписаниеМетаданных, ИмяКоллекции) Экспорт
